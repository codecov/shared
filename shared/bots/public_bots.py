...
from shared.bots.helpers import get_token_type_from_config
from shared.bots.types import TokenTypeMapping, TokenWithOwner
...
def get_public_bot_token(service: Service, repoid: int) -> TokenWithOwner:
    ...
    if tokenless_bot_dict and tokenless_bot_dict.get("key"):
        ...
        tokenless_bot_dict["entity_name"] = tokenless_bot_dict.get("username")
