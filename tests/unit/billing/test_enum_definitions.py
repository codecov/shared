...
class TestBillingServiceTestCase(object):
    ...
    def test_pr_author_plan_check(self, request, dbsession, mocker, mock_configuration):
    ...
    def test_pr_author_enterprise_plan_check(
        self, request, dbsession, mocker, mock_configuration
    ):
    ...
    @override_settings(IS_ENTERPRISE=False)
    def test_plan_not_pr_author(self, request, dbsession, mocker, mock_configuration):
    ...
    def test_get_from_string(self):
        ...
        assert (
            BillingPlan.from_str("users-enterprisey")
    ...
    def test_is_enterprise_cloud_plan(self):
