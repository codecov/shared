...
class TestUnitGithub(object):
    ...
    @pytest.mark.asyncio
    async def test_create_issue(self, respx_vcr, valid_handler):
        mocked_response = respx_vcr.post(
            url="https://api.github.com/repos/ThiagoCodecov/example-python/issues",
            json={
                "title": "Found a bug",
            ...
            return_value=httpx.Response(
                status_code=201,
                json={
                    "url": "https://api.github.com/repos/test-user/demo-project/issues/4",
                    "repository_url": "https://api.github.com/repos/test-user/demo-project",
                    "labels_url": "https://api.github.com/repos/test-user/demo-project/issues/4/labels{/name}",
                    "comments_url": "https://api.github.com/repos/test-user/demo-project/issues/4/comments",
                    "events_url": "https://api.github.com/repos/test-user/demo-project/issues/4/events",
                    "html_url": "https://github.com/test-user/demo-project/issues/4",
                    "id": 2198374669,
                    "node_id": "I_kwDOLfZReM6DCIkN",
                    "number": 4,
                    "title": "Found a bug",
                    "user": {
                        "login": "test-user",
                        "id": 136376984,
                        "node_id": "U_kgDOCCDymA",
                        "avatar_url": "https://avatars.githubusercontent.com/u/136376984?v=4",
                        "gravatar_id": "",
                    ...
                    "milestone": None,
                    "comments": 0,
                    "created_at": "2024-03-20T19:20:42Z",
                    "updated_at": "2024-03-20T19:20:42Z",
                    "closed_at": None,
                    "author_association": "OWNER",
                    ...
                    "closed_by": None,
                    "reactions": {
                        "url": "https://api.github.com/repos/test-user/demo-project/issues/4/reactions",
                        "total_count": 0,
                        "+1": 0,
                        "-1": 0,
                        "laugh": 0,
                    ...
                    "timeline_url": "https://api.github.com/repos/test-user/demo-project/issues/4/timeline",
                    "performed_via_github_app": None,
                    "state_reason": None,
                },
                headers={"Content-Type": "application/json; charset=utf-8"},
        ...
        res = await valid_handler.create_issue(
            "Found a bug", "I'm having a problem with this."
        )
        assert res == expected_result
        assert mocked_response.called is True
